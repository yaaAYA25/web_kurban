...
<body>
    ...
    <table>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>
            <a href='edit_hewan.php?id=" . $row['id'] . "'>Edit</a> | 
            <a href='../proses/proses_hapus_hewan.php?id=" . $row['id'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\">Hapus</a>
          </td>";
            echo "</tr>";
        }
