                        ...
                        ?>
                            <tr>
                                ...
                                <td class="p-4 text-gray-700">
                                    <?php
                                    $getUser = $koneksi->query("SELECT id_user FROM users WHERE warga_id=$user_id")->fetch_assoc();
                                    echo $row['nik']; // Menampilkan NIK dari tabel warga
                                    ?>
                                    <input type="hidden" name="user_id[<?= $user_id ?>]" value="<?= $getUser['id_user'] ?? 0 ?>">
